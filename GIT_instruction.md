...
Ура! Удаленный репозиторий получил все файлы и коммиты нашего локального репозитория.
...
Рассмотрим три варианта связки - два через  - попроще (без истории своих коммитов) и полноценный (передаем все, включая свои старые коммиты).
Для обоих случаев сначала мы должны сделать `fork` проекта, к которому хотим присоединиться
